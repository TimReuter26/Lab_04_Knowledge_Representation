...
class ProcessDuieData:
    def __init__(self):
        ...
        self.raw_data_path = os.path.join(self.base_dir, "duie_data")
        self.data_path = os.path.join(self.base_dir, "data", "duie") + os.sep
            ...
            for i, line in enumerate(tqdm(lines)):
                ...
                for j, spo in enumerate(spo_list):
                    ...
                    try:
                        ...
                        subject_re_res = re.finditer(re.escape(spo['subject']), text)
                    ...
                    try:
                        ...
                        object_re_res = re.finditer(re.escape(spo['object']['@value']), text)
